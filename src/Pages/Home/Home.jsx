      ...
      <main className=" max-w-screen-2xl mx-auto px-5 md:px-10 lg:px-20">
        <section className="my-10 lg:mb-20">
          <div className="grid gap-5 md:grid-cols-2 lg:grid-cols-3">
            {/* apple brand */}
            <Link to="/apple" className="w-full   border shadow-md py-5">
            ...
            {/* intel brand */}
            <Link to="/intel" className="w-full border shadow-md py-5">
              <div className="w-full h-[250px] flex justify-center items-start">
            ...
            {/* google */}
            <Link to="/google" className="w-full border shadow-md py-5">
              <div className="w-full h-[250px] flex justify-center items-start">
                <img
            ...
            {/* sony  */}
            <Link to="/sony" className="w-full border shadow-md py-5">
              <div className="w-full h-[250px] flex justify-center items-start">
            ...
            {/* samsung */}
            <Link to="/samsung" className="w-full border shadow-md py-5">
              <div className="w-full h-[250px] flex justify-center items-start">
            ...
            {/* dell */}
            <Link to="/dell" className="w-full border shadow-md py-5">
              <div className="w-full h-[250px] flex justify-center items-start">
